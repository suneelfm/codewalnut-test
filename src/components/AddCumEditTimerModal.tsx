...
// If passing isEdit true then the timer prop should be passed
...
type ModalProps = AddTimerModalProps & EditTimerModalProps;

export const AddCumEditTimerModal: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  isEdit,
  timer,
  ...
  // Setting up the existed data for editing
  useEffect(() => {
    if (isOpen && isEdit) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // If opened the modal for edit triggering the edit time action
    if (isEdit) {
      editTimer(timer.id, {
        title: title.trim(),
      ...
      addTimer({
        ...
        description: description.trim(),
        duration: totalSeconds,
        hours, // useful for edit
        minutes, // useful for edit
        seconds, // useful for edit
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none w-full px-3 py-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">
